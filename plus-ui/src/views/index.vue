  ...
  <div class="app-container home">
    <el-row :gutter="20">
      <el-col :sm="24" :lg="12" style="padding-left: 20px">
        <h2>智能游泳馆管理系统</h2>
        <p>
          智能游泳馆管理系统 是基于 RuoYi-Vue 针对 分布式集群 场景升级(不兼容原框架)
          <br />
        ...
        <p>
          <el-button type="primary" icon="Cloudy" plain @click="goTarget('https://gitee.com/dromara/智能游泳馆管理系统')">访问码云</el-button>
          <el-button type="primary" icon="Cloudy" plain @click="goTarget('https://github.com/dromara/智能游泳馆管理系统')">访问GitHub</el-button>
          <el-button type="primary" icon="Cloudy" plain @click="goTarget('https://plus-doc.dromara.org/#/智能游泳馆管理系统/changlog')"
            >更新日志</el-button
          >
        </p>
      </el-col>
